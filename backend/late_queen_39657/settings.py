"""
Django settings for late_queen_39657 project.
...
ROOT_URLCONF = 'late_queen_39657.urls'
...
WSGI_APPLICATION = 'late_queen_39657.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_queen_39657 API",
    "DESCRIPTION": "API documentation for late_queen_39657 App",
    "VERSION": "v1",
}
